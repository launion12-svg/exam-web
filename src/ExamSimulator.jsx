...
const ExamSimulator = () => {
  const allQuestions = [
    {
      ...
      correct: 1,
      explanation: "La arquitectura Harvard separa físicamente la memoria de instrucciones y la de datos, eliminando el cuello de botella de Von Neumann."
    },
    {
      id: 2,
      unit: "UT1",
      ...
      correct: 2,
      explanation: "El kernel monolítico ejecuta todo el código del sistema operativo en un único espacio de memoria privilegiado."
    },
    {
      id: 3,
      unit: "UT1",
      ...
      correct: 2,
      explanation: "El diseño de hardware no es función del sistema operativo. Las funciones básicas son gestión de procesos, memoria, archivos y dispositivos."
    },
    {
      id: 4,
      unit: "UT2",
      ...
      correct: 1,
      explanation: "GPT (GUID Partition Table) soporta discos >2 TB y hasta 128 particiones, superando las limitaciones de MBR."
    },
    {
      id: 5,
      unit: "UT2",
      ...
      correct: 1,
      explanation: "El ESP (EFI System Partition) es una partición FAT32 donde residen los cargadores EFI necesarios para UEFI."
    },
    {
      id: 6,
      unit: "UT2",
    ...
    },
    {
      ...
      correct: 1,
      explanation: "/etc/fstab (file systems table) contiene la configuración de montajes automáticos que se ejecutan durante el arranque."
    },
    {
      id: 8,
      unit: "UT3",
  ...
  // Verificar que hay preguntas antes de renderizar
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-gray-800">
              Examen - Implantación de Sistemas Operativos
            </h1>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
            ...
            {question.options.map((option, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-full p-4 rounded-lg border-2 ${bgColor} ${borderColor} text-left transition-all duration-200 flex items-center justify-between ${!showResults && 'hover:shadow-md'}`}
                >
          ...
          {isAnswered && showExplanation && (
            <div className={`mt-6 p-4 rounded-lg ${isCorrect ? 'bg-green-50 border-2 border-green-200' : 'bg-blue-50 border-2 border-blue-200'}`}>
